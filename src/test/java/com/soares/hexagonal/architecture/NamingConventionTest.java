package com.soares.hexagonal.architecture;
...
@AnalyzeClasses(packages = "com.soares.hexagonal")
public class NamingConventionTest {
    ...
    public static final ArchRule message_reside_only_message_package = classes()
            ...
            .as("Message classes reside inside message package in consumer package");
    ...
    public static final ArchRule controller_reside_only_controller_package = classes()
            ...
            .as("Controller classes reside inside controller package in adapters.in package");
    ...
    public static final ArchRule adapter_reside_only_adapter_package = classes()
            ...
            .as("Adapter classes reside inside out package in adapters package");
    ...
    public static final ArchRule client_reside_only_client_package = classes()
            ...
            .as("Client classes reside inside client package in adapters.out package");
